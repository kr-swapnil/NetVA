#=========================================================================================
#' Detects vulnerable proteins (VPs) based on five-point summary of boxplot
#'
#' This function detects vulnerable proteins (VPs) based on five-point summary of boxplot.
#' It takes first input a numeric vector of topological values for all nodes; whereas,
#' second a keyword for topological property based on which users want to identify VPs.
